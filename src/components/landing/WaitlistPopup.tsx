...
export default function WaitlistPopup({ isReady, isExpanded, onCollapse, onExpand, onSuccess }: WaitlistPopupProps) {
    ...
    return (
      <button
        ...
        className="fixed z-50 bottom-0 left-0 right-0 sm:bottom-4 sm:left-auto sm:right-4 sm:w-[420px]
          flex items-center justify-between gap-3 bg-primary px-5 py-3.5 text-white shadow-large
          sm:rounded-xl rounded-t-xl transition-all duration-200 hover:bg-primary-hover cursor-pointer"
      >
  ...
  return (
    ...
    >
      <div className="max-h-[80vh] overflow-y-auto rounded-t-2xl bg-white shadow-large sm:rounded-2xl">
        {/* Header */}
        <div className="sticky top-0 flex items-center justify-between bg-white px-5 pt-5 pb-2 sm:px-6 sm:pt-6">
